...
<template>
  <div style="width:33px;height:33px;">
    <a 
      title="Edit" 
      @mouseover="
        localCallMouseOverOrLeave('isHoveredEdit', true, i, j, k, l)
      " 
      @mouseleave="
        localCallMouseOverOrLeave('isHoveredEdit', false, i, j, k, l)
      " 
      @click="localOpenEditShowOrAddCollections('isClickedEdit', i, j, k, l)"
      ...
      :style="
        ...
        ).isClickedEdit? 'background-color:#663600;' : ''
      "
    >
      <div class="w-100 h-100 flex-box flex-direction-row align-items-center justify-content-center p-0 m-0" style="padding:5px;">
        <img 
          ...
          localToggleButtonIcon(['isHoveredEdit', 'isClickedEdit'], ['edit.svg', 'edit-hover.svg'], i, j, k, l)
          " 
